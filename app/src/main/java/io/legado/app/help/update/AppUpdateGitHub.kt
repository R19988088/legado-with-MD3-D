...
object AppUpdateGitHub : AppUpdate.AppUpdateInterface {
    ...
    private suspend fun getLatestRelease(): List<AppReleaseInfo> {
        val url = if (checkVariant == AppVariant.OFFICIAL)
            "https://api.github.com/repos/R19988088/legado-with-MD3-D/releases/latest"
        else
            "https://api.github.com/repos/R19988088/legado-with-MD3-D/releases"
    ...
    suspend fun getReleaseByTag(tag: String): AppUpdate.UpdateInfo? {
        val url = "https://api.github.com/repos/R19988088/legado-with-MD3-D/releases/tags/$tag"
        val res = okHttpClient.newCallResponse { url(url) }
    ...
    private data class SemVer(
        ...
        companion object {
            fun parse(version: String): SemVer {
                ...
                return SemVer(maj.toInt(), min.toInt(), pat.toIntOrNull() ?: 0, pre.ifBlank { null })
            }
        }
    }
